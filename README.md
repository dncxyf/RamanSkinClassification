...
分类模型对比（2500 条，5 类，75/25 分层划分）:
  PLS-DA       Acc=0.880  F1=0.875  
  SVM(RBF)     Acc=0.882  F1=0.882  综合★
  RandomForest Acc=0.861  F1=0.860
  KNN          Acc=0.718  F1=0.715  (基线)

PLS 定量:  R²(CV)=0.767  RMSE(CV)=0.098
PCA:       前 5 个 PC 解释 30.5%
聚类:      KMeans ARI=0.006  GMM ARI=0.190  (监督 >> 无监督)
```
